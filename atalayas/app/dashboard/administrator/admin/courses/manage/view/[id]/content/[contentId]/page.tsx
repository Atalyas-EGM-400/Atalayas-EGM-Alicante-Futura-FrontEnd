      ...
      <main className="flex-1 overflow-auto flex flex-col relative">
        ...
        <div className="p-6 lg:p-10 flex-1 max-w-6xl mx-auto w-full">
          <motion.div
            ...
            className="mb-6 flex items-center gap-2 text-xs text-muted-foreground bg-muted/50 rounded-full px-3 py-1.5 w-fit"
          >
          ...
          >
            ...
            <aside className="space-y-6">
              ...
              {content.url && !content.url.includes('.mp3') && (
                <div className="bg-white dark:bg-[#1c1c1e] border border-gray-100 dark:border-white/5 rounded-3xl p-6 shadow-sm text-center group hover:border-primary/50 transition-colors">
